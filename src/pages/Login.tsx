...
import { Loader2, Music, Phone, Mail } from "lucide-react";
      ...
      <Card className="w-full max-w-md border-border shadow-lg my-auto">
        ...
        <CardContent>
            ...
            <TabsContent value="phone">
                {!showPhoneOtp ? (
                    <form onSubmit={handlePhoneSignIn} className="space-y-4 pt-4">
                        <div className="space-y-2">
                            ...
                            <Input 
                                ...
                                required
                            />
                            <p className="text-xs text-muted-foreground">Enter country code (e.g. +1 for USA)</p>
                        </div>
                    ...
                    <div className="space-y-6 pt-4 text-center">
                        ...
                        <Button onClick={handlePhoneVerify} className="w-full" disabled={phoneOtp.length !== 6 || loading}>
                            Verify & Sign In
                        </Button>
                        <Button variant="ghost" className="w-full text-xs" onClick={() => setShowPhoneOtp(false)}>
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <Button variant="outline" type="button" onClick={() => handleOAuthLogin('spotify')}>
